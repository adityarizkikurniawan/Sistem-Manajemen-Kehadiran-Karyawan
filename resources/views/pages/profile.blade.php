        ...
        <div class="px-8 pb-10">
            <div class="relative flex flex-col md:flex-row items-center md:items-end -mt-16 gap-6">
                <div class="h-32 w-32 bg-white p-2 rounded-3xl shadow-lg">
                    <div
                        class="h-full w-full bg-blue-100 rounded-2xl flex items-center justify-center text-blue-600 text-4xl font-bold">
                        ARK
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <a href="{{ route('profil.export_pdf', ['bulan' => date('m')]) }}" class="btn btn-danger">
                    <i class="fas fa-file-pdf"></i> Download Laporan Bulan Ini
                </a>
